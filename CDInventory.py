#------------------------------------------#
# Title: Assignment07
# Desc: Working with classes, functions, and binary data.
...
# JRoe, 2020-Aug-26, Add error calls at delete, and daa processor / file processor classses
# JRoe, 2020-Aug-26, Changed perminant file handling to binary
#------------------------------------------#
...
open(strFileName, 'ab').close() #Creates blank file
...
while True:
    ...
    # 3.5 process delete a CD
        ...
        try:
            intDDel1 = int(intIDDel)      
        except ValueError:
            print('\nIntegers Only!\n') 

        # 3.5.2 search thru table and delete CD
        DataProcessor.delete_fxn(intDDel1, lstTbl)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
